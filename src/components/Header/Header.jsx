    ...
    const links = <>
        <li className="flex ">
            <NavLink to="/" className={({isActive }) =>
                isActive ? 'text-[#23BE0A] font-bold border border-[#23BE0A]' : 'font-bold'
            }>Home</NavLink>
        </li>
        <li className="flex">
        ...
        <div className="navbar bg-base-100 container mx-auto p-4">
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul tabIndex={0} className="menu menu-sm dropdown-content mx-2 mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
                        {links}
                    </ul>
                </div>
                <a className="btn btn-ghost normal-case text-xl text-[#23BE0A] font-bold">Book Vibe</a>
            </div>
